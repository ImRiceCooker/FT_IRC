...
public:
	...
	event_map command_mode(const uintptr_t &ident, t_mode &mode);
	event_map command_invite(const uintptr_t &ident, std::string &user, std::string &chan_name);
	event_map command_mode_i_on(const uintptr_t &ident, t_mode &mode);
	event_map command_mode_i_off(const uintptr_t &ident, t_mode &mode);
	event_map command_mode_k_on(const uintptr_t &ident, t_mode &mode);
	event_map command_mode_k_off(const uintptr_t &ident, t_mode &mode);
	event_map command_mode_o_on(const uintptr_t &ident, t_mode &mode);
	event_map command_mode_o_off(const uintptr_t &ident, t_mode &mode);
	event_map command_mode_t_on(const uintptr_t &ident, t_mode &mode);
	event_map command_mode_t_off(const uintptr_t &ident, t_mode &mode);
	event_map command_mode_l_on(const uintptr_t &ident, t_mode &mode);
	event_map command_mode_l_off(const uintptr_t &ident, t_mode &mode);
	static event_map (Database::*run_mode_func_ptr[N_MODE_TYPE])(const uintptr_t &ident, t_mode &mode);
